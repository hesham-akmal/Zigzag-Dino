...
/// <summary>
/// CanvasHelper will resize a child RectTransform named "SafeArea" to fit Screen.safeArea.
/// SafeArea RectTransform must be stretched Horizontally and Vertically ( Anchors: min is (0,0). max is (1,1) )
/// While this script is applied to the original parent canvas
/// For more explanation: URL: https://forum.unity.com/threads/canvashelper-resizes-a-recttransform-to-iphone-xs-safe-area.521107/
/// Credits: _Adriaan (profile url: https://forum.unity.com/members/_adriaan.12147/)
/// </summary>
...
public class CanvasHelper : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError("No child gameobject with the name SafeArea was found!");
        }
